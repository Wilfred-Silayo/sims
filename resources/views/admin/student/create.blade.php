...
<div class="container bg-white justify-content-center">
    <h2 class="mb-2" id="registerLabel">Register Student</h2>
    <hr>
    <form action="{{route('store.student')}}" id="register-student-form" method="POST">
        @csrf
        <div class="row mb-3">
...
<script>
function sendForm() {
    document.getElementById("register-student-form").submit();
}
</script>
@endsection